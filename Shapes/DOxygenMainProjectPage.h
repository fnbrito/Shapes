...
/// The shapes project must be separated into one superclass called Shape and two subclasses called Circle and Square.
/// The subclasses will inherit the datamembers and the public functions. Additionally they'll have three added virtual functions.
